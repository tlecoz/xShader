...
test("throws", function () {
    ...
    throws(function () {
        throw new Error();
    }, Error, "raised error is an instance of CustomError");
    throws(function () {
...
test("Arrays Basics.", function () {
    ...
    equal(QUnit.equiv([[], [], []], [[], [], []]), true);
    equal(QUnit.equiv([[], [], [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]], [[], [], [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]), true);
    equal(QUnit.equiv([[], [], [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]], [[], [], [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]), // shorter
    false);
    equal(QUnit.equiv([[], [], [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[{}]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]], [[], [], [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]), // deepest element not an array
    false);
});
...
QUnit.test("propEqual", 5, function (assert) {
    ...
    assert.notPropEqual(new Foo('1', 2, 3), {
        x: 1,
        y: '2',
        z: 3
    ...
    assert.propEqual(new Foo(1, '2', new Foo([3], new Bar(), null)), {
        x: 1,
        y: '2',
        z: {
            x: [3],
...
if (typeof document !== "undefined") {
    ...
    (function () {
        var delayNextSetup, sleep = function (n) {
            stop();
        ...
        var getPreviousTests;
        QUnit.test("basics", 2, function () {
            var previous = getPreviousTests(/^setup$/, /^timing$/)[0], runtime = previous.lastChild.previousSibling;
        ...
        QUnit.test("values", 2, function () {
            var basics = getPreviousTests(/^setup$/, /^timing$/)[0], slow = getPreviousTests(/^basics$/, /^timing$/)[0];
